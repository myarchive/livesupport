...
Meteor.langs = new Meteor.Collection("langs");
Meteor.depts = new Meteor.Collection("depts");
Meteor.teams = new Meteor.Collection("teams");
Meteor.guests = new Meteor.Collection("guests");
Meteor.visits = new Meteor.Collection("visits");
